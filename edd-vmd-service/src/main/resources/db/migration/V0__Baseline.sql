-- Baseline version for existing database schema
-- This script won't be executed on existing databases due to baseline-on-migrate configuration
...
CREATE TABLE IF NOT EXISTS `tb_bom_part` (
  ...
  `PART_TYPE` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '零件类型 P01：一般件，P02：标准件，P0201:非标件(卡接类)，P0202：非标件(螺接类)，P03工艺合件，P04:软件，P05:辅料，P06 板料，P07 卷料，P09售后专用件、P11精品附件、P12专用工具，后续增加零件类型 ',
  ...
  `PART_STATUS` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '零件状态 值：D、T、P ',
  `IS_DIGITATE` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '是否有数模 名称：N、Part、Product 值：N（无）、Part（零件）、Product（总成） ',
  `UNIT` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '用量单位 值：EA，KG，ML,M2,M ',
  `IS_FRAME_PART` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '是否架构件 名称：是、否 值：1、0 ',
  `IS_NATURE_PART` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '是否本色件 名称：是、否 值：1、0 ',
  `COLOR_AREA` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '颜色区域 名称：I、E 值：I（内饰）、E（外饰） ',
  `NATURE_PART_NO` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '本色件号 ',
  `IS_REGULATORY_PART` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '法规件 名称：是、否值：1、0 ',
  `INITIAL_MODEL` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '初始车型 ',
  `ISKEY_PART` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '关重特性 名称：关键件、重要件、一般件值：KEY、MAJOR、SIMPLE ',
  `IS_ACCURATELY_TRACED` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '是否精准追溯 名称：是、否值：1、0 ',
  `IS_AFTERSALES_PART` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '是否售后配件 名称：是、否 值：1、0（无查询筛选条件） ',
  ...
  `IS_WASHER` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '是否带垫圈 名称：是、否值：1、0 ',
  ...
  `ECU_IDENTIFICTION` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'ECU标识 是否软件，硬件，总成标识 ',
  ...
  `IS_COLOR_REPARE` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '颜色件维修 是否可用颜色件维修 ',
  ...
  `PRODUCTION_CODE` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '对应生产件号 MBOM料号 ',
...
CREATE TABLE IF NOT EXISTS `tb_bom_part_nove` (
  ...
  `MATERIAL_NAME_EN` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '零件英文名称 FFC编码 ',
  `PART_TYPE` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '零件类型 ',
  `PRODUCT` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '车型 多个值逗号隔开，如R11,R12 ',
  `BASE_PRODUCT` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '基础车型 多个值逗号隔开，如R1101,R1102，R101,R1202 ',
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='配置项表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='配置项映射表';
...
CREATE TABLE IF NOT EXISTS `tb_config_item_option` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_config_item` (`config_item_code`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='配置项枚举值表';
...
CREATE TABLE IF NOT EXISTS `tb_device` (
  ...
  `device_item` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '设备项',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `code` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='设备信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='MES车辆数据表';
...
CREATE TABLE IF NOT EXISTS `tb_part` (
  ...
  `device_form` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '设备形态',
  `device_code` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '设备代码',
  ...
  `sale_note` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '售后备注',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `pn` (`pn`)
) ENGINE=InnoDB AUTO_INCREMENT=10018 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='零件信息表';
...
CREATE TABLE IF NOT EXISTS `tb_supplier` (
  ...
  `county` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '区',
  `subdistrict` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '街道',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=980 DEFAULT CHARSET=utf8mb3 COMMENT='供应商表';
...
CREATE TABLE IF NOT EXISTS `tb_veh_base_model` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `code` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆基础车型表';

-- 车辆基础车型特征值关系表
CREATE TABLE IF NOT EXISTS `tb_veh_base_model_feature_code` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `base_model_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '基础车型代码',
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆基础车型特征值关系表';
...
CREATE TABLE IF NOT EXISTS `tb_veh_basic_info` (
  ...
  `model_code` varchar(255) NOT NULL COMMENT '车型代码',
  `base_model_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '基础车型代码',
  `build_config_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '生产配置代码',
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆基础信息表';
...
CREATE TABLE IF NOT EXISTS `tb_veh_brand` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `code` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆品牌表';
...
CREATE TABLE IF NOT EXISTS `tb_veh_build_config` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `code` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆生产配置表';
...
CREATE TABLE IF NOT EXISTS `tb_veh_detail_info` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_vin` (`vin`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆详细信息表';
...
CREATE TABLE IF NOT EXISTS `tb_veh_ecu` (
  ...
  `valid` tinyint NOT NULL DEFAULT '1' COMMENT '是否有效',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8mb3 COMMENT='车辆ECU表';

-- 车辆外饰表
CREATE TABLE IF NOT EXISTS `tb_veh_exterior` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `platform_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '车辆平台代码',
  `series_code` varchar(255) NOT NULL COMMENT '车系代码',
  ...
  `row_valid` tinyint DEFAULT '1' COMMENT '记录是否有效',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆外饰表';
...
) ENGINE=InnoDB AUTO_INCREMENT=183 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆特征值表';
...
CREATE TABLE IF NOT EXISTS `tb_veh_feature_family` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `code` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=289 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆特征族表';
...
CREATE TABLE IF NOT EXISTS `tb_veh_import_data` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `batch_num` (`batch_num`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆导入数据表';
...
CREATE TABLE IF NOT EXISTS `tb_veh_interior` (
  ...
  `row_valid` tinyint DEFAULT '1' COMMENT '记录是否有效',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆内饰表';
...
CREATE TABLE IF NOT EXISTS `tb_veh_manufacturer` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `code` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆生产厂商表';
...
CREATE TABLE IF NOT EXISTS `tb_veh_model` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `code` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆车型表';
...
CREATE TABLE IF NOT EXISTS `tb_veh_optional` (
  ...
  `row_valid` tinyint DEFAULT '1' COMMENT '记录是否有效',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆选装表';
...
CREATE TABLE IF NOT EXISTS `tb_veh_platform` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `code` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆平台表';
...
CREATE TABLE IF NOT EXISTS `tb_veh_preset_owner` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_vin` (`vin`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆预设车主表';
...
CREATE TABLE IF NOT EXISTS `tb_veh_series` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `code` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆车系表';
...
CREATE TABLE IF NOT EXISTS `tb_veh_wheel` (
  ...
  `row_valid` tinyint DEFAULT '1' COMMENT '记录是否有效',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆车轮表';
...
CREATE TABLE IF NOT EXISTS `tb_vehicle_part` (
  ...
  `hardware_pn` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '硬件零件号',
  `software_pn` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '软件零件号',
  ...
  KEY `idx_vin` (`vin`),
  KEY `idx_pn` (`pn`)
) ENGINE=InnoDB AUTO_INCREMENT=135 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆零件表';
...
CREATE TABLE IF NOT EXISTS `tb_vehicle_part_history` (
  ...
  KEY `idx_vin` (`vin`),
  KEY `idx_pn` (`pn`)
) ENGINE=InnoDB AUTO_INCREMENT=349 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆零件变更历史表';
