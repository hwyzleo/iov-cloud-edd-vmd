...
import net.hwyz.iov.cloud.edd.vmd.service.application.VehicleModelConfigAppService;
...
public class ServiceVehicleModelConfigController {
    ...
    public String getVehicleBuildConfigCode(@RequestParam String baseModelCode, @RequestParam String exteriorCode,
        ...
        log.info("根据车型配置类型[{}:{}:{}:{}:{}:{}:{}:{}]得到匹配的车型配置代码", baseModelCode, exteriorCode, interiorCode,
