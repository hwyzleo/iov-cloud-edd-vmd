...
public class MptDeviceController extends BaseController {
    ...
    public ApiResponse listAllDevice() {
        ...
        List<Map<String, Object>> list = new ArrayList<>();
        for (VmdDeviceDo device : deviceAppService.listAll()) {
    ...
    public ApiResponse getInfo(@PathVariable Long deviceId) {
        ...
        VmdDeviceDo devicePo = deviceAppService.getDeviceById(deviceId);
        return ApiResponse.ok(DeviceMapper.INSTANCE.fromDo(devicePo));
    }
    ...
    public ApiResponse add(@Validated @RequestBody DeviceVo device) {
        ...
        VmdDeviceDo devicePo = DeviceMapper.INSTANCE.toDo(device);
