...
import net.hwyz.iov.cloud.edd.vmd.service.application.ModelAppService;
...
public class MptModelController extends BaseController {
    ...
    public ApiResponse<ModelVo> getInfo(@PathVariable Long modelId) {
        ...
        VmdVehModelDo modelPo = modelAppService.getModelById(modelId);
        return ApiResponse.ok(ModelMapper.INSTANCE.fromDo(modelPo));
    }
    ...
    public ApiResponse<Void> add(@Validated @RequestBody ModelVo model) {
        ...
        VmdVehModelDo modelPo = ModelMapper.INSTANCE.toDo(model);
