 ...
 */
@Mapper
public interface MdmOptionFamilyMapper extends BaseDao<MdmOptionFamilyPo, Long> {
     ...
     * @return 车辆选装族信息
     */
    MdmOptionFamilyPo selectPoByCode(String code);
     ...
     * @return 车辆选装族信息
     */
    MdmOptionFamilyPo selectPoByExternalRefId(@Param("externalRefId") String externalRefId);
