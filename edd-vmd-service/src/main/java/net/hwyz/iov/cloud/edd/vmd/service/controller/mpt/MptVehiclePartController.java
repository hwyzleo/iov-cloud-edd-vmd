...
import net.hwyz.iov.cloud.edd.vmd.service.application.mapper.VehiclePartMapper;
...
public class MptVehiclePartController extends BaseController {
    ...
    public ApiResponse getInfo(@PathVariable Long vehiclePartId) {
        ...
        VmdVehiclePartDo vehiclePartPo = vehiclePartAppService.getVehiclePartById(vehiclePartId);
        return ApiResponse.ok(VehiclePartMapper.INSTANCE.fromDo(vehiclePartPo));
    }
    ...
    public ApiResponse add(@Validated @RequestBody VehiclePartVo vehiclePart) {
        ...
        VmdVehiclePartDo vehiclePartPo = VehiclePartMapper.INSTANCE.toDo(vehiclePart);
