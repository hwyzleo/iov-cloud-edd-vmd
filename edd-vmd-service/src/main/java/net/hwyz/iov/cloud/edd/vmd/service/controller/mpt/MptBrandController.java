...
import net.hwyz.iov.cloud.edd.vmd.service.application.BrandAppService;
...
public class MptBrandController extends BaseController {
    ...
    public ApiResponse<BrandVo> getInfo(@PathVariable Long brandId) {
        ...
        VmdVehBrandDo brandPo = brandAppService.getBrandById(brandId);
        return ApiResponse.ok(BrandMapper.INSTANCE.fromDo(brandPo));
    }
    ...
    public ApiResponse<Void> add(@Validated @RequestBody BrandVo brand) {
        ...
        VmdVehBrandDo brandPo = BrandMapper.INSTANCE.toDo(brand);
