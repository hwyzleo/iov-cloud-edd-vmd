...
import net.hwyz.iov.cloud.edd.vmd.service.application.ConfigItemAppService;
import net.hwyz.iov.cloud.edd.vmd.service.application.mapper.ConfigItemMapper;
import net.hwyz.iov.cloud.edd.vmd.service.application.mapper.ConfigItemMappingMapper;
import net.hwyz.iov.cloud.edd.vmd.service.application.mapper.ConfigItemOptionMapper;
...
public class MptConfigItemController extends BaseController {
    ...
    public ApiResponse listOption(@PathVariable String configItemCode, ConfigItemOptionVo configItemOption) {
        ...
        List<VmdConfigItemOptionDo> configItemOptionPoList = configItemAppService.searchOption(configItemCode, configItemOption.getCode(),
                configItemOption.getName(), getBeginTime(configItemOption), getEndTime(configItemOption));
        return ApiResponse.ok(ConfigItemOptionMapper.INSTANCE.fromDoList(configItemOptionPoList));
    }
    ...
    public ApiResponse listMapping(@PathVariable String configItemCode, ConfigItemMappingVo configItemMapping) {
        ...
        List<VmdConfigItemMappingDo> configItemMappingPoList = configItemAppService.searchMapping(configItemCode,
                configItemMapping.getSourceSystem(), getBeginTime(configItemMapping), getEndTime(configItemMapping));
        return ApiResponse.ok(ConfigItemMappingMapper.INSTANCE.fromDoList(configItemMappingPoList));
    }
    ...
    public ApiResponse getInfo(@PathVariable Long configItemId) {
        ...
        VmdConfigItemDo configItemPo = configItemAppService.getConfigItemById(configItemId);
        return ApiResponse.ok(ConfigItemMapper.INSTANCE.fromDo(configItemPo));
    }
    ...
    public ApiResponse getOptionInfo(@PathVariable String configItemCode, @PathVariable Long configItemOptionId) {
        ...
        VmdConfigItemOptionDo configItemOptionPo = configItemAppService.getConfigItemOptionById(configItemCode, configItemOptionId);
        return ApiResponse.ok(ConfigItemOptionMapper.INSTANCE.fromDo(configItemOptionPo));
    }
    ...
    public ApiResponse getMappingInfo(@PathVariable String configItemCode, @PathVariable Long configItemMappingId) {
        ...
        VmdConfigItemMappingDo configItemMappingPo = configItemAppService.getConfigItemMappingById(configItemCode, configItemMappingId);
        return ApiResponse.ok(ConfigItemMappingMapper.INSTANCE.fromDo(configItemMappingPo));
    }
    ...
    public ApiResponse add(@Validated @RequestBody ConfigItemVo configItem) {
        ...
        VmdConfigItemDo configItemPo = ConfigItemMapper.INSTANCE.toDo(configItem);
    ...
    public ApiResponse addOption(@PathVariable String configItemCode, @Validated @RequestBody ConfigItemOptionVo configItemOption) {
        ...
        VmdConfigItemOptionDo configItemOptionPo = ConfigItemOptionMapper.INSTANCE.toDo(configItemOption);
    ...
    public ApiResponse addMapping(@PathVariable String configItemCode, @Validated @RequestBody ConfigItemMappingVo configItemMapping) {
        ...
        VmdConfigItemMappingDo configItemMappingPo = ConfigItemMappingMapper.INSTANCE.toDo(configItemMapping);
