...
import net.hwyz.iov.cloud.edd.vmd.service.application.VehicleConfigAppService;
...
public class MptVehicleConfigController extends BaseController {
    ...
    public ApiResponse getInfo(@PathVariable Long vehicleConfigId) {
        ...
        VmdVehicleConfigDo vehicleConfigPo = vehicleConfigAppService.getVehicleConfigById(vehicleConfigId);
        return ApiResponse.ok(VehicleConfigMapper.INSTANCE.fromDo(vehicleConfigPo));
    }
    ...
    public ApiResponse getConfigItemInfo(@PathVariable String vin, @PathVariable Long vehicleConfigItemId) {
        ...
        VmdVehicleConfigItemDo vehicleConfigItemPo = vehicleConfigAppService.getVehicleConfigItemById(vin, vehicleConfigItemId);
        return ApiResponse.ok(VehicleConfigItemMapper.INSTANCE.fromDo(vehicleConfigItemPo));
    }
}
