...
import net.hwyz.iov.cloud.edd.vmd.service.application.FeatureFamilyAppService;
import net.hwyz.iov.cloud.edd.vmd.service.application.mapper.FeatureCodeMapper;
...
public class MptFeatureFamilyController extends BaseController {
    ...
    public ApiResponse<PageResult<FeatureCodeVo>> listFeatureCode(@PathVariable Long featureFamilyId, FeatureCodeVo featureCode) {
        ...
        startPage();
        List<VmdVehFeatureCodeDo> featureCodePoList = featureFamilyAppService.searchFeatureCode(featureFamilyId, null,
                featureCode.getName(), featureCode.getName(), getBeginTime(featureCode), getEndTime(featureCode));
        List<FeatureCodeVo> featureCodeVoList = FeatureCodeMapper.INSTANCE.fromDoList(featureCodePoList);
    ...
    public ApiResponse<List<FeatureCodeVo>> listAllFeatureCode(@RequestParam String familyCode) {
        ...
        List<VmdVehFeatureCodeDo> featureCodePoList = featureFamilyAppService.searchFeatureCode(null, familyCode, null, null, null, null);
        return ApiResponse.ok(FeatureCodeMapper.INSTANCE.fromDoList(featureCodePoList));
    }
    ...
    public ApiResponse<FeatureFamilyVo> getInfo(@PathVariable Long featureFamilyId) {
        ...
        VmdVehFeatureFamilyDo featureFamilyPo = featureFamilyAppService.getFeatureFamilyById(featureFamilyId);
        return ApiResponse.ok(FeatureFamilyMapper.INSTANCE.fromDo(featureFamilyPo));
    }
    ...
    public ApiResponse<FeatureCodeVo> getFeatureCodeInfo(@PathVariable Long featureFamilyId, @PathVariable Long featureCodeId) {
        ...
        VmdVehFeatureCodeDo featureCodePo = featureFamilyAppService.getFeatureCodeById(featureFamilyId, featureCodeId);
        return ApiResponse.ok(FeatureCodeMapper.INSTANCE.fromDo(featureCodePo));
    }
    ...
    public ApiResponse<Void> add(@Validated @RequestBody FeatureFamilyVo featureFamily) {
        ...
        VmdVehFeatureFamilyDo featureFamilyPo = FeatureFamilyMapper.INSTANCE.toDo(featureFamily);
    ...
    public ApiResponse<Void> addFeatureCode(@PathVariable Long featureFamilyId, @Validated @RequestBody FeatureCodeVo featureCode) {
        ...
        VmdVehFeatureCodeDo featureCodePo = FeatureCodeMapper.INSTANCE.toDo(featureCode);
