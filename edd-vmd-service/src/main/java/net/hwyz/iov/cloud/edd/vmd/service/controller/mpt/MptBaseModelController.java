...
import net.hwyz.iov.cloud.edd.vmd.service.application.BaseModelAppService;
...
public class MptBaseModelController extends BaseController {
    ...
    public ApiResponse<List<BaseModelFeatureCodeVo>> listFeatureCode(@PathVariable String baseModelCode, BaseModelFeatureCodeVo baseModelFeatureCode) {
        ...
        baseModelFeatureCodeVoList.forEach(mpt -> {
            VmdVehFeatureFamilyDo featureFamily = featureFamilyAppService.getFeatureFamilyByCode(mpt.getFamilyCode());
            ...
            for (String code : mpt.getFeatureCode()) {
                VmdVehFeatureCodeDo featureCode = featureFamilyAppService.getFeatureCodeByCode(code);
                if (featureCode != null) {
    ...
    public ApiResponse<BaseModelVo> getInfo(@PathVariable Long baseModelId) {
        ...
        VmdVehBaseModelDo baseModelPo = baseModelAppService.getBaseModelById(baseModelId);
        return ApiResponse.ok(BaseModelMapper.INSTANCE.fromDo(baseModelPo));
    }
    ...
    public ApiResponse<Void> add(@Validated @RequestBody BaseModelVo baseModel) {
        ...
        VmdVehBaseModelDo baseModelPo = BaseModelMapper.INSTANCE.toDo(baseModel);
    ...
    public ApiResponse<Void> addFeatureCode(@PathVariable String baseModelCode, @Validated @RequestBody BaseModelFeatureCodeVo baseModelFeatureCode) {
        ...
        VmdVehBaseModelFeatureCodeDo baseModelFeatureCodePo = BaseModelFeatureCodeMapper.INSTANCE.toDo(baseModelFeatureCode);
