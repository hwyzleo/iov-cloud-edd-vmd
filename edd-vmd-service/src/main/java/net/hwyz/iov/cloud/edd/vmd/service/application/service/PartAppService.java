...
public class PartAppService {
    ...
    public List<PartVo> search(String key, String pn, String name, String type, String deviceCode, Date beginTime, Date endTime) {
        ...
        List<PartPo> partPoList = partMapper.selectPoByMap(map);
        return PageUtil.convert(partPoList, PartAssembler.INSTANCE::fromPo);
    }
    ...
    public List<PartPo> listAllFota(Boolean software) {
        return partMapper.selectAllFotaPo(software);
    }
    ...
    public PartPo getPartById(Long id) {
        return partMapper.selectPoById(id);
    }
    ...
    public PartPo getPartByPn(String pn) {
        return partMapper.selectPoByPn(pn);
    }
    ...
    public int createPart(PartPo part) {
        return partMapper.insertPo(part);
    }
    ...
    public int modifyPart(PartPo part) {
        return partMapper.updatePo(part);
    }
