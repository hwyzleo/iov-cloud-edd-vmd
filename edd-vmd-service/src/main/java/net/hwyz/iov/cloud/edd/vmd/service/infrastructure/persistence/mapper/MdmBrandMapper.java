 ...
 */
@Mapper
public interface MdmBrandMapper extends BaseDao<MdmBrandPo, Long> {
     ...
     * @return 车辆品牌信息
     */
    MdmBrandPo selectPoByCode(String code);
    ...
    MdmBrandPo selectPoByExternalRefId(@Param("externalRefId") String externalRefId);
