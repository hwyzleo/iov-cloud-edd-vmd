 ...
 */
@Rollback
class VehCarLineRepositoryTest extends BaseTest {
    ...
    void insert_shouldSuccessfullyInsertCarLine() {
        ...
        // When
        int result = vehCarLineRepository.insert(carLine);
    ...
    void selectById_shouldReturnCarLineWhenExists() {
        ...
        // When
        CarLine result = vehCarLineRepository.selectById(carLine.getId());
    ...
    void selectByCode_shouldReturnCarLineWhenCodeExists() {
        ...
        // When
        CarLine result = vehCarLineRepository.selectByCode(code);
    ...
    void update_shouldSuccessfullyUpdateCarLine() {
        ...
        carLine.setSort(10);
        int result = vehCarLineRepository.update(carLine);

        // Then
        assertEquals(1, result);
        CarLine updatedCarLine = vehCarLineRepository.selectById(carLine.getId());
    ...
    void batchPhysicalDelete_shouldSuccessfullyDeleteCarLines() {
        ...
        CarLine carLine2 = CarLine.builder()
                ...
                .sort(6)
                .build();
        vehCarLineRepository.insert(carLine1);
        vehCarLineRepository.insert(carLine2);

        Long[] ids = {carLine1.getId(), carLine2.getId()};

        // When
        int result = vehCarLineRepository.batchPhysicalDelete(ids);

        // Then
        assertEquals(2, result);
        assertNull(vehCarLineRepository.selectById(carLine1.getId()));
        assertNull(vehCarLineRepository.selectById(carLine2.getId()));
    }
    ...
    void selectByMap_shouldReturnCarLinesMatchingCriteria() {
        ...
        // When
        List<CarLine> result = vehCarLineRepository.selectByMap(map);
    ...
    void countByMap_shouldReturnCorrectCount() {
        ...
        // When
        int result = vehCarLineRepository.countByMap(map);
    ...
    void countBySource_shouldReturnCountForSource() {
        ...
        CarLine carLineManual = CarLine.builder()
                ...
                .source(SourceType.MANUAL)
                .build();
        vehCarLineRepository.insert(carLineMdm);
        vehCarLineRepository.insert(carLineManual);

        // When
        long mdmCount = vehCarLineRepository.countBySource(SourceType.MDM);
        long manualCount = vehCarLineRepository.countBySource(SourceType.MANUAL);
    ...
    void insert_shouldSuccessfullyInsertMdmCarLineWithProjectionFields() {
        ...
        CarLine insertedCarLine = vehCarLineRepository.selectById(carLine.getId());
