...
/**
 * VehPlatformRepository集成测试
 *
 * @author hwyz_leo
 */
@Rollback
class VehPlatformRepositoryTest extends BaseTest {
    ...
    void insert_shouldSuccessfullyInsertPlatform() {
        ...
        // When
        int result = vehPlatformRepository.insert(platform);
    ...
    void selectById_shouldReturnPlatformWhenExists() {
        ...
        // When
        Platform result = vehPlatformRepository.selectById(platform.getId());
    ...
    void selectByCode_shouldReturnPlatformWhenCodeExists() {
        ...
        // When
        Platform result = vehPlatformRepository.selectByCode(code);
    ...
    void update_shouldSuccessfullyUpdatePlatform() {
        ...
        platform.setSort(10);
        int result = vehPlatformRepository.update(platform);

        // Then
        assertEquals(1, result);
        Platform updatedPlatform = vehPlatformRepository.selectById(platform.getId());
    ...
    void batchPhysicalDelete_shouldSuccessfullyDeletePlatforms() {
        ...
        Platform platform2 = Platform.builder()
                ...
                .sort(6)
                .build();
        vehPlatformRepository.insert(platform1);
        vehPlatformRepository.insert(platform2);

        Long[] ids = {platform1.getId(), platform2.getId()};

        // When
        int result = vehPlatformRepository.batchPhysicalDelete(ids);

        // Then
        assertEquals(2, result);
        assertNull(vehPlatformRepository.selectById(platform1.getId()));
        assertNull(vehPlatformRepository.selectById(platform2.getId()));
    }
    ...
    void selectByMap_shouldReturnPlatformsMatchingCriteria() {
        ...
        // When
        List<Platform> result = vehPlatformRepository.selectByMap(map);
    ...
    void countByMap_shouldReturnCorrectCount() {
        ...
        // When
        int result = vehPlatformRepository.countByMap(map);
    ...
    void selectByExternalRefId_shouldReturnPlatformWhenExternalRefIdExists() {
        ...
        // When
        Platform result = vehPlatformRepository.selectByExternalRefId(externalRefId);
    ...
    void countBySource_shouldReturnCountForSource() {
        ...
        Platform platformManual = Platform.builder()
                ...
                .source(SourceType.MANUAL)
                .build();
        vehPlatformRepository.insert(platformMdm);
        vehPlatformRepository.insert(platformManual);

        // When
        long mdmCount = vehPlatformRepository.countBySource(SourceType.MDM);
        long manualCount = vehPlatformRepository.countBySource(SourceType.MANUAL);
    ...
    void insert_shouldSuccessfullyInsertMdmPlatformWithProjectionFields() {
        ...
        Platform insertedPlatform = vehPlatformRepository.selectById(platform.getId());
